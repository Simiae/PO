...
(
   ID INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	...
	HodinaPrednaskyAnglicky float not null default '2.4',
	HodinaCviceniAnglicky float not null default '1.8',
	HodinaSeminareAnglicky float not null default '1.8',
	UdeleniJednohoZapoctu float not null default '0.2',
	UdeleniJednohoKlasifikovanehoZapoctu float not null default '0.3',
	UdeleniJedneZkousky float not null default '0.4',
	UdeleniJednohoZapoctuAnglicky float not null default '0.2',
	UdeleniJednohoKlasifikovanehoZapoctuAnglicky float not null default '0.3',
	UdeleniJedneZkouskyAnglicky float not null default '0.4',
